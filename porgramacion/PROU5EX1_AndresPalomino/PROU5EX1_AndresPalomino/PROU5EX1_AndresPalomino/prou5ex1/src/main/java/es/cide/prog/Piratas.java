...
public class Piratas extends Pirata{
    ...
    public Piratas(String nombre, int vida, boolean acertada) {
        super(nombre, vida);
        this.vivo = true;
        this.acertada = true;
    ...
    public void sayHello(){
        System.out.println("Voy a acabar contigo, sucia rata.");
    }

    //Método de despedida al morir
    @Override
    public void sayGoodBye(){
        System.out.println("El Kraken terminará mi trabajo ¡esto no es el final!");
    }
